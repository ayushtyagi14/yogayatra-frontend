...
const AddGalleryPhoto = ({ getGalleryPhotos }) => {
  ...
  function handleSubmit(event) {
    ...
    if (image) {
      ...
      formData.append("photoHeading", photoName);
      ...
      fetch(process.env.BACKEND + "admin/addGalleryPhoto", requestOptions)
        ...
        .then((result) => {
          ...
          if (data.resCode === 200) {
            ...
            setShowModal(false);
            getGalleryPhotos(); // Call getGalleryPhotos here after adding the photo
          } else {
          ...
          >
            <div className="relative w-max my-6 mx-auto mt-[5rem]">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none pb-5 px-10 overflow-y-auto">
                ...
                <div className="flex flex-col items-center mt-4 w-full">
                  <label htmlFor="Photo-name">Photo Heading:</label>
                  <input
                    type="text"
                    id="Photo-name"
                    name="Photo-Name"
