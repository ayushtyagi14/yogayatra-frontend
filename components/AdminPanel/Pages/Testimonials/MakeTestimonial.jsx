...
const MakeTestimonial = ({ getAllTestimonials }) => {
  ...
  function handleSubmit(event) {
    ...
    if (image) {
      ...
      formData.append("testimonialPersonName", testimonialPersonName);
      formData.append("testimonialPersonDesig", testimonialPersonDesig);
      ...
      fetch(process.env.BACKEND + "admin/makeTestimonial", requestOptions)
    ...
    <>
      <div className="flex items-center justify-center mt-5">
        ...
        >
          ...
          <span className="font-medium">Add a Testimonial</span>
        </button>
      </div>
...
export default MakeTestimonial;
